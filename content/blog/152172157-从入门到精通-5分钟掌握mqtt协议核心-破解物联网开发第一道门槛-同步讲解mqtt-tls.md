...
date: 2025-09-27
summary: 跟随虾哥项目实践，硬件选小智就对了 xiaozhi 开源方案官方适配，二次开发文档齐全 点击查看 MQTT协议概述 MQTT（Message Queuing Telemetry Transport）是…
tags: [CSDN同步, 物联网, 网络协议]
...
- 三种服务质量（QoS）： ◦ QoS 0：最多一次传输（不确认）。 ◦ QoS 1：至少一次传输（需要确认）。 ◦ QoS 2：仅一次传输（确保消息不重复且不丢失）。
...
PublisherBrokerSubscriber订阅主题A发布消息到主题A推送消息给订阅者PublisherBrokerSubscriber
...
> 原载 [CSDN](https://blog.csdn.net/weixin_52400878/article/details/152172157)，同步至本站。
