...
date: 2023-05-04
summary: "还在苦于Kindle的epub格式吗？python爬虫，一键爬取小说加txt转换epub。项目地址：爬取地址为独步小说网站，本博客仅用于学习作用。"
tags: ["CSDN同步", "python", "爬虫", "开发语言"]
...
> 原文发布于 [CSDN](https://blog.csdn.net/weixin_52400878/article/details/130482474)
