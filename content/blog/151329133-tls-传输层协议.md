...
title: TLS 传输层协议
date: 2025-09-08
summary: TLS，全称是传输层安全协议（Transport Layer Security），是用于保障互联网通信安全的协议。它的主要任务是确保数据在客户端和服务器之间传输的安全性和完整性。TLS 是 SSL（S…
tags: [CSDN同步, 网络, 网络安全]
...
ClientServerHandshake Protocol"Client Hello (ClientHello)""Server Hello (ServerHello)""Certificate (Certificate)"Optional Steps"Certificate Request (CertificateRequest)"Mandatory Steps"Certificate Verification""Key Generation (Pre-master secret)""Client Key Exchange (ClientKeyExchange)"Optional Steps"Client Certificate (Certificate)"Mandatory Steps"Change Cipher Spec (ChangeCipherSpec)""Change Cipher Spec (ChangeCipherSpec)""Finished (Finished)""Finished (Finished)"Record Protocol"Application Data (ApplicationData)""Application Data (ApplicationData)"ClientServer
...
> 原载 [CSDN](https://blog.csdn.net/weixin_52400878/article/details/151329133)，同步至本站。
